...
// Add Workshop Event to Google Calendar
...
// Add Activity to Learner's Google Calendar
...
// Get Workshop Location Details using Google Maps
app.get('/workshops/:id/location', authenticate, async (req, res) => {
  try {
    ...
    // Assume a Maps API call here (pseudo code)
